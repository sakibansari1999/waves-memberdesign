...
function ActivityRow({ icon, title, subtitle }: ActivityItem) {
  return (
...
export default function RecentActivities() {
  const activities: ActivityItem[] = [
    {
      title: "Trip Completed on Fig Tales",
      subtitle: "Hope you had a great time! · 2 days ago",
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M7.5 3C7.5 3.82787 8.17213 4.5 9 4.5C9.82787 4.5 10.5 3.82787 10.5 3C10.5 2.17213 9.82787 1.5 9 1.5C8.17213 1.5 7.5 2.17213 7.5 3V3" stroke="#4B5563" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    },
    {
      title: "Fuel Charge Processed",
      subtitle: "$142.50 · 2 days ago",
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Invoice #2938 Paid",
      subtitle: "Membership Dues · Oct 1",
      icon: (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 3.75H15C15.8279 3.75 16.5 4.42213 16.5 5.25V12.75C16.5 13.5779 15.8279 14.25 15 14.25H3C2.17213 14.25 1.5 13.5779 1.5 12.75V5.25C1.5 4.42213 2.17213 3.75 3 3.75V3.75" stroke="#4B5563" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
