      ...
      */}
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-3 mt-3">
          <div className="flex items-center gap-1">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_2029_383)">
                <path
        ...
        <div className="flex items-center gap-4 mb-3 mt-1">
          {/* Length */}
          <div className="w-full max-w-[150px] flex items-center justify-between gap-2 px-3 py-2 bg-[#FAFBFD] border border-[#EEF2F6] rounded-[12px] whitespace-nowrap">
            <div className="flex items-center gap-2">
              {/* SVG */}
              <svg
                width="16"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_2029_228)">
                  <path
          ...
          <div className="w-full max-w-fit flex items-center justify-between gap-2 px-3 py-2 bg-[#FAFBFD] border border-[#EEF2F6] rounded-[12px]">
            <div className="flex items-center gap-2">
              {/* SVG */}
              <svg
                width="16"
          ...
          {/* Motor */}
          <div className="max-w-[180px] w-full flex items-center justify-between gap-2 px-3 py-2 bg-[#FAFBFD] border border-[#EEF2F6] rounded-[12px] whitespace-nowrap">
            <div className="flex items-center gap-2">
              {/* SVG */}
              <svg
                width="16"
        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-auto items-center justify-between">
          ...
          */}
          ...
          <div className="flex flex-col gap-1 px-4">
            <p className="text-base text-[#0F1723] font-bold">Notes</p>
            <p className="text-sm text-[#1F2937] font-normal max-w-[300px]">
